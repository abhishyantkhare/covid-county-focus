...
const DESCRIPTION_4 = "One thing to keep in mind is that not all hospital beds are empty and not all cases will be hospitalized, so there isn't a 1-1 correspondence between cases and beds. "
